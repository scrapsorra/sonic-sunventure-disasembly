ToxicLandfill_Header:
	...
	smpsHeaderFM        ToxicLandfill_FM1,	$0C, $0C
	smpsHeaderFM        ToxicLandfill_FM2,	$0C, $0C	
	smpsHeaderFM        ToxicLandfill_FM3,	$00, $09
	smpsHeaderFM        ToxicLandfill_FM4,	$00, $09
	smpsHeaderFM        ToxicLandfill_FM5,	$F4, $13
	smpsHeaderPSG       ToxicLandfill_PSG1,	$00, $04, $00, $00
	smpsHeaderPSG       ToxicLandfill_PSG2,	$00, $04, $00, $00
...
ToxicLandfill_Loop43:
	...
	smpsLoop            $01, $04, ToxicLandfill_Loop42
...
ToxicLandfill_Loop30:
	...
	dc.b	nG3, $06, $06, nBb3
	smpsLoop            $00, $02, ToxicLandfill_Loop30
...
ToxicLandfill_Loop31:
	dc.b	nBb3, $02, nA3, $01
	smpsLoop            $00, $04, ToxicLandfill_Loop31
...
ToxicLandfill_Loop34:
	...
	smpsLoop            $00, $02, ToxicLandfill_Loop34
	smpsLoop            $01, $02, ToxicLandfill_Loop33
...
ToxicLandfill_Loop35:
	...
	smpsLoop            $01, $02, ToxicLandfill_Loop36
...
ToxicLandfill_Loop23:
	...
	smpsLoop            $00, $03, ToxicLandfill_Loop23
...
ToxicLandfill_Loop25:
	dc.b	nC2, nC2, nBb2
	smpsLoop            $00, $03, ToxicLandfill_Loop25
	dc.b	nC2, nBb2

ToxicLandfill_Loop26:
	dc.b	nC2, nBb2, nC2
	smpsLoop            $00, $04, ToxicLandfill_Loop26
	dc.b	nC2, nBb2, nG2, nBb2, nB2
	smpsLoop            $01, $04, ToxicLandfill_Loop27

ToxicLandfill_Loop28:
	dc.b	nC3, $06, $06, nG2, nG2, $03, nBb2, $09, nG2, $06, nBb2, nB2
	smpsLoop            $00, $02, ToxicLandfill_Loop28

ToxicLandfill_Loop29:
	dc.b	nC3, nC3, nF2, nF2, $03, nG2, $09, $06, nBb2, nB2
	smpsLoop            $00, $02, ToxicLandfill_Loop29
	smpsLoop            $01, $02, ToxicLandfill_Loop28
...
ToxicLandfill_Loop2A:
	dc.b	nC2, nC2, nBb2
	smpsLoop            $00, $03, ToxicLandfill_Loop2A
	dc.b	nC2, nBb2

ToxicLandfill_Loop2B:
	dc.b	nC2, nBb2, nC2
	smpsLoop            $00, $04, ToxicLandfill_Loop2B
	dc.b	nC2, nBb2, nG2, nBb2, nB2
	smpsLoop            $01, $04, ToxicLandfill_Loop2C

ToxicLandfill_Loop2D:
	dc.b	nC3, $06, nG2, nBb2, nB2, $03, nC3, $09, nG2, $06, nBb2, nB2
	smpsLoop            $00, $02, ToxicLandfill_Loop2D
	dc.b	nC3, nF2, nG2, nBb2, $03, nC3, $09, nF2, $06, nG2, nBb2, nG2
	dc.b	$09, $09, $09, $09, $06, nBb2
	smpsLoop            $01, $02, ToxicLandfill_Loop2D
...
ToxicLandfill_Loop2F:
	dc.b	nC3, nC3, nF2, nF2, $03, nG2, $09, $06, nBb2, nB2
	smpsLoop            $00, $02, ToxicLandfill_Loop2F
	smpsLoop            $01, $04, ToxicLandfill_Loop2E
	smpsJump            ToxicLandfill_Loop24
...
ToxicLandfill_Loop16:
	...
	smpsLoop            $00, $03, ToxicLandfill_Loop16
...
ToxicLandfill_Loop17:
	...
	smpsLoop            $00, $02, ToxicLandfill_Loop17
...
ToxicLandfill_Loop18:
	dc.b	nC1, nC1, nBb1
	smpsLoop            $00, $03, ToxicLandfill_Loop18
	dc.b	nC1, nBb1

ToxicLandfill_Loop19:
	dc.b	nC1, nBb1, nC1
	smpsLoop            $00, $04, ToxicLandfill_Loop19
	dc.b	nC1, nBb1, nG1, nBb1, nB1
	smpsLoop            $01, $04, ToxicLandfill_Loop1A
...
ToxicLandfill_Loop1C:
	...
	smpsLoop            $01, $02, ToxicLandfill_Loop1B
...
ToxicLandfill_Loop1D:
	dc.b	nC1, nC1, nBb1
	smpsLoop            $00, $03, ToxicLandfill_Loop1D
	dc.b	nC1, nBb1

ToxicLandfill_Loop1E:
	dc.b	nC1, nBb1, nC1
	smpsLoop            $00, $04, ToxicLandfill_Loop1E
	dc.b	nC1, nBb1, nG1, nBb1, nB1
	smpsLoop            $01, $04, ToxicLandfill_Loop1F

ToxicLandfill_Loop20:
	dc.b	nC2, $06, nG1, nBb1, nB1, $03, nC2, $09, nG1, $06, nBb1, nB1
	smpsLoop            $00, $02, ToxicLandfill_Loop20
	dc.b	nC2, nF1, nG1, nBb1, $03, nC2, $09, nF1, $06, nG1, nBb1, nG1
	dc.b	$09, $09, $09, $09, $06, nBb1
	smpsLoop            $01, $02, ToxicLandfill_Loop20
...
ToxicLandfill_Loop22:
	dc.b	nC2, nC2, nF1, nF1, $03, nG1, $09, $06, nBb1, nB1
	smpsLoop            $00, $02, ToxicLandfill_Loop22
	smpsLoop            $01, $04, ToxicLandfill_Loop21
	smpsJump            ToxicLandfill_Loop17
...
ToxicLandfill_Loop11:
	dc.b	$70
	smpsLoop            $00, $18, ToxicLandfill_Loop11

ToxicLandfill_Loop12:
	dc.b	nC5, $06, nG4, nBb4, nB4, $03, nC5, $09, nG4, $06, nBb4, nB4
	smpsLoop            $00, $02, ToxicLandfill_Loop12

ToxicLandfill_Loop13:
	dc.b	nC5, nF4, nG4, nBb4, $03, nC5, $09, nF4, $06, nG4, nBb4
	smpsLoop            $00, $02, ToxicLandfill_Loop13

ToxicLandfill_Loop14:
	dc.b	nC6, nG5, nBb5, nB5, $03, nC6, $09, nG5, $06, nBb5, nB5
	smpsLoop            $00, $02, ToxicLandfill_Loop14

ToxicLandfill_Loop15:
	dc.b	nC6, nF5, nG5, nBb5, $03, nC6, $09, nF5, $06, nG5, nBb5
...
ToxicLandfill_Loop4C:
	dc.b	$60
	smpsLoop            $00, $08, ToxicLandfill_Loop4C
...
ToxicLandfill_Loop4F:
	...
	smpsLoop            $00, $02, ToxicLandfill_Loop4F
...
ToxicLandfill_Loop50:
	dc.b	$6E
	smpsLoop            $00, $07, ToxicLandfill_Loop50
...
ToxicLandfill_Loop52:
	dc.b	nC3, nF2, nG2, nBb2, $03, nC3, $09, nF2, $06, nG2, nBb2
	smpsLoop            $00, $02, ToxicLandfill_Loop52
	smpsLoop            $01, $03, ToxicLandfill_Loop51
...
ToxicLandfill_Loop46:
	dc.b	$60
	smpsLoop            $00, $08, ToxicLandfill_Loop46
	...
	dc.b	nF2, nG2, nD2, nF2, nFs2, $03, nG2, $09, nD2, $06, nF2, nFs2
	dc.b	nG2, nD2, nF2, nFs2, $03, nRst, $01, nG2, $08, nD2, $06, nF2
	dc.b	nFs2, nG2, nC2, nD2, nF2, $03, nG2, $09, nC2, $06, nD2, nF2
	dc.b	nG2, nC2, nD2, nF2, $03, nG2, $08, nRst, $01, nC2, $06, nD2
	dc.b	nF2, $05, nRst
...
ToxicLandfill_Loop47:
	dc.b	$60
	smpsLoop            $00, $08, ToxicLandfill_Loop47
	dc.b	$01
...
ToxicLandfill_Loop49:
	...
	smpsLoop            $00, $02, ToxicLandfill_Loop49

ToxicLandfill_Loop4A:
	dc.b	nG2, nC2, nD2, nF2, $03, nG2, $09, nC2, $06, nD2, nF2
	smpsLoop            $00, $02, ToxicLandfill_Loop4A
...
ToxicLandfill_Loop45:
	...
	smpsLoop            $00, $0C, ToxicLandfill_Loop45
	dc.b	$5A
