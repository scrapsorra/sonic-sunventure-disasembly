...
ptr_Mozzietron:		dc.l Mozzietron
ptr_RShieldItem:	dc.l RShieldItem	
...
id_GShielditem:		equ ((ptr_GShieldItem-Obj_Index)/4)+1
id_Obj05:		equ ((ptr_Obj05-Obj_Index)/4)+1
id_Mozzietron:		equ ((ptr_Mozzietron-Obj_Index)/4)+1
id_RShieldItem:		equ ((ptr_RShieldItem-Obj_Index)/4)+1	
...
id_InvStars:		equ ((ptr_InvStars-Obj_Index)/4)+1
