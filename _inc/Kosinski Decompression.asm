...
;
; For format explanation see http://info.sonicretro.org/Kosinski@compression
; New faster version by written by vladikcomper, with additional improvements by
; MarkeyJester and Flamewing
; Converted to ASM68K by Beta Filter.
; ---------------------------------------------------------------------------
Kos_UseLUT: equ 1
Kos_LoopUnroll: equ 3
Kos_ExtremeUnrolling: equ 1
