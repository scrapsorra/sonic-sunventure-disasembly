...
Sonic_Animatecont:	
		...
		bclr	#5,obStatus(a0)	; clear pushing flag	;Mercury Pushing While Walking Fix	;Mercury Constants
...
@walkrunroll:
	...
	@noinvert:
		...
		eor.b	d1,d2
		or.b	d2,obRender(a0)
		btst	#5,obStatus(a0)	; is Sonic pushing something?	;Mercury Constants
