...
WaterSwitcher:
		...
		jmp	PSwapper_Index(pc,d1.w) ;TIS Don't Delete if out of range
...
PSwapper_Init:
		...
		move.l	#Map_WaterSwitcher,obMap(a0)
...
; sprite mappings
; -------------------------------------------------------------------------------
Map_WaterSwitcher:	include "_maps\WaterSwitcher.asm"
; ===========================================================================
