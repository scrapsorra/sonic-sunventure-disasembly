...
FMSetFreq:
		...
		move.w	(a0,d5.w),TrackFreq(a5)	; Store new frequency
		rts
...
Music93:	incbin	"sound/music/Mus93 - Get Emerald.bin"
		even
Music94:	include	"sound/music/Boss2.asm"
		even
...
SoundA1:	incbin	"sound/sfx/SndA1 - Lamppost.bin"
		even
SoundA2:	include	"sound/sfx/DrowningSound.asm"
		even
SoundA3:	incbin	"sound/sfx/SndA3 - Death.bin"
		even
SoundA4:	incbin	"sound/sfx/SndA4 - Skid.bin"
		even
SoundA5:	include	"sound/sfx/LargeRingBox.asm"
		even
...
SoundA9:	incbin	"sound/sfx/SndA9 - SS Item.bin"
		even
SoundAA:	include	"sound/sfx/Splash.asm"
		even
SoundAB:	include	"sound/sfx/FireShield.asm"
		even
SoundAC:	incbin	"sound/sfx/SndAC - Hit Boss.bin"
		even
SoundAD:	incbin	"sound/sfx/SndAD - Get Bubble.bin"
		even
SoundAE:	include	"sound/sfx/Fireball.asm"
		even
...
SoundB5:	incbin	"sound/sfx/SndB5 - Ring.bin"
		even
SoundB6:	include	"sound/sfx/Spikes.asm"
		even
SoundB7:	incbin	"sound/sfx/SndB7 - Rumbling.bin"
		even
SoundB8:	include	"sound/sfx/ScoreTallying.asm"
		even
SoundB9:	include	"sound/sfx/BreakFloor.asm"
		even
SoundBA:	incbin	"sound/sfx/SndBA - SS Glass.bin"
		even
SoundBB:	incbin	"sound/sfx/SndBB - Door.bin"
		even
SoundBC:	include	"sound/sfx/DashRelease.asm"
		even
...
SoundC1:	incbin	"sound/sfx/SndC1 - Break Item.bin"
		even
SoundC2:	include	"sound/sfx/DrowningWarning.asm"
		even
SoundC3:	incbin	"sound/sfx/SndC3 - Giant Ring.bin"
		even
SoundC4:	incbin	"sound/sfx/SndC4 - Bomb.bin"
		even
SoundC5:	include	"sound/sfx/Cash Register.asm"
		even
...
SoundCB:	incbin	"sound/sfx/SndCB - Wall Smash.bin"
		even
SoundCC:	include	"sound/sfx/Spring.asm"
		even
SoundCD:	include	"sound/sfx/Beep.asm"
		even
SoundCE:	incbin	"sound/sfx/SndCE - Ring Left Speaker.bin"
		even
SoundCF:	include	"sound/sfx/Signpost.asm"
		even
